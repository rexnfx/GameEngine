    ...
    public class PlatformerGame : Microsoft.Xna.Framework.Game {
        ...
        protected override void Update(GameTime gameTime) {
            ...
            level.Update(gameTime, keyboardState, gamePadState,
                         accelerometerState, mouseState, Window.CurrentOrientation);
        ...
        private void DrawHud() {
            ...
            //DrawShadowedString(hudFont, "MOUSE: X: " + mouseState.X.ToString() +", Y: " + mouseState.Y.ToString(), hudLocation + new Vector2(0.0f, timeHeight * 2.4f), Color.Yellow);
